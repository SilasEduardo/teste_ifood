...
function solucao(peso1, peso2) {
  // seu codigo aqui
    if (peso1 < 55) peso1 = "Peso leve"
    if (peso1 >= 55 && peso1 < 65) peso1 =  "Peso meio-médio"
    if (peso1 >= 65 && peso1 < 75) peso1 = "peso médio"
    if (peso1 >= 75 && peso1 < 85) peso1 = "Peso meio-pesado"
    if (peso1 >= 85) peso1 = "Peso pesado"  
  
  
    if (peso2 < 55) peso2 = "Peso leve"
    if (peso2 >= 55 && peso2 < 65) peso2 =  "Peso meio-médio"
    if (peso2 >= 65 && peso2 < 75) peso2 = "peso médio"
    if (peso2 >= 75 && peso2 < 85) peso2 = "Peso meio-pesado"
    if (peso2 >= 85) peso2 = "Peso pesado" 
